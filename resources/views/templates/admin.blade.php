...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('admin_template/plugins/images/favicon.png') }}">
    <!-- Custom CSS -->
   <link href="{{ asset('admin_template/css/style.min.css') }}" rel="stylesheet">
...
<![endif]-->
    <script src="{{ asset('admin_template/plugins/bower_components/jquery/dist/jquery.min.js') }}"></script>
...
<body>
    ...
    <script src="{{ asset('admin_template/js/app-style-switcher.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('admin_template/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('admin_template/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
